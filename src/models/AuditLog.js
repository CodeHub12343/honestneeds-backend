...
const AuditLogSchema = new mongoose.Schema(
  {
    ...
    // Free-form action key in `domain.action` form (e.g. 'user.blocked',
    // 'campaign.approved', 'config.updated'). Kept as an open string so new
    // admin actions never cause a write to be silently rejected — the previous
    // hard enum was a frequent source of lost audit entries.
    action_type: {
      type: String,
      required: true,
      index: true,
